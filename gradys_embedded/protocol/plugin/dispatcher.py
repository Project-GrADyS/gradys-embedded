...
This module contains a function that creates a dispatcher which wraps a protocol instance and it's methods. Implements
 ...
 Use this module through the **create_dispatcher**][gradys_embedded.protocol.plugin.dispatcher.create_dispatcher] method,
...
class ProtocolWrapper:
    ...
    [create_dispatcher][gradys_embedded.protocol.plugin.dispatcher.create_dispatcher].
    ...
    def __init__(self, protocol: IProtocol):
        ...
        [create_dispatcher][gradys_embedded.protocol.plugin.dispatcher.create_dispatcher] method.
    ...
    def register_initialize(self, handler: Callable[[IProtocol, int], None]) -> None:
        """
        Registers a handler for the [initialize][gradys_embedded.protocol.interface.IProtocol.initialize] method. Handlers should
    ...
    def register_handle_timer(self, handler: Callable[[IProtocol, str], DispatchReturn]) -> None:
        """
        Registers a handler for the [handle_timer][gradys_embedded.protocol.interface.IProtocol.handle_timer] method. Handlers should
    ...
    def register_handle_telemetry(self, handler: Callable[[IProtocol, Telemetry], DispatchReturn]) -> None:
        """
        Registers a handler for the [handle_telemetry][gradys_embedded.protocol.interface.IProtocol.handle_telemetry] method. Handlers
    ...
    def register_handle_packet(self, handler: Callable[[IProtocol, str], DispatchReturn]) -> None:
        """
        Registers a handler for the [handle_packet][gradys_embedded.protocol.interface.IProtocol.handle_packet] method. Handlers should
    ...
    def register_finish(self, handler: Callable[[IProtocol], None]) -> None:
        """
        Registers a handler for the [handle_timer][gradys_embedded.protocol.interface.IProtocol.finish] method. Handlers should
