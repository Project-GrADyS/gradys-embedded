...
from gradys_embedded.protocol.plugin.dispatcher import DispatchReturn, create_dispatcher
...
class RandomMobilityConfig:
    """
    Configuration class for the [RandomMobilityPlugin][gradys_embedded.protocol.plugin.random_mobility.RandomMobilityPlugin] class.
    """
...
class RandomMobilityPlugin:
    ...
    [initiate_random_trip][gradys_embedded.protocol.plugin.random_mobility.RandomMobilityPlugin.initiate_random_trip] method to start
    ...
    [finish_random_trip][gradys_embedded.protocol.plugin.random_mobility.RandomMobilityPlugin.finish_random_trip] method.

    If you only want to make the node travel to a random waypoint once, you can use the
    [travel_to_random_waypoint][gradys_embedded.protocol.plugin.random_mobility.RandomMobilityPlugin.travel_to_random_waypoint] method.
    """
