...
- `→ https://github.com/Project-GrADyS/gradys-sim-nextgen/.claude/docs/plugins-and-extensions.md` — the same plugin set in the simulator, plus Extensions (Radio, Camera) that do not apply here.
