...
- `→ https://github.com/Project-GrADyS/gradys-sim-nextgen/.claude/docs/messages-and-telemetry.md` — the abstract shapes (`MobilityCommand`, `Telemetry`, `Position`, `geo_to_cartesian`) that this project implements.
